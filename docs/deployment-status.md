...
Only `SYNC_LIPSYNC_QUALIFIED=true` together with a configured Sync key may expose visual lip-sync as qualified to API admission and Workflow execution. Production runtime remains **UNQUALIFIED** until that real fixture completes end-to-end.
