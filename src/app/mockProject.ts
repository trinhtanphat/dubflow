...
export const mockProject: StudioProject = {
  ...
  speakers: [
    { id: 'lin', name: '林婉儿', gender: 'Nữ', share: 28, accent: 'violet', initials: 'LW' },
    { id: 'ye', name: '夜无痕', gender: 'Nam', share: 35, accent: 'blue', initials: 'YW' },
    { id: 'mo', name: '墨无极', gender: 'Nam', share: 22, accent: 'green', initials: 'MW' },
  ],
  segments: [
    { id: 's1', speakerId: 'lin', startMs: 0, endMs: 7000, sourceText: '你终于来了', translatedText: 'Cuối cùng chàng cũng đến.' },
    { id: 's2', speakerId: 'lin', startMs: 8000, endMs: 16000, sourceText: '我等你很久了。', translatedText: 'Ta đã đợi chàng rất lâu rồi.' },
