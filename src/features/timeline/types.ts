...
export type StudioProject = { id: string; title: string; durationMs: number; sourceLanguage: 'auto'|'zh'|'en'|'ja'|'ko'; targetLanguage: 'vi'; speakers: Speaker[]; segments: Segment[] };
